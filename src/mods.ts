...
const THEME_API = 'https://raw.githubusercontent.com/Hrishikeshmind/astradesktop/main/themes.json'

export async function getAllMods(): Promise<AstraTheme[]> {
  try {
